...
function votefunction(){
	...
	if(Voteid.value.includes("@")&&(checkvote.checked)){
		Voteid.value="";
        Voteid.placeholder=("Votre vote a bien été pris en compte!");
        checkboxvoter.style="color:#004181;"
    }
    if(!checkvote.checked){
        console.log("non")
        checkboxvoter.style="color:red;"
    }
	if((!Voteid.value)||(!Voteid.value.includes("@"))){
